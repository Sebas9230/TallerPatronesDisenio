...
namespace DesignPatterns.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IVehicleRepository vehicleRepository, ILogger<HomeController> logger, IVehicleFactory vehicleFactory)
        {
        ...
        //Metodo usando Factory Method
        [HttpGet]
        public IActionResult AddExplorer()
        {
            var vehicle = _vehicleFactory.CreateVehicle("Red");
